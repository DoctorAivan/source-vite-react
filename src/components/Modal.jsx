...
const Modal = ({
    ...
    return (
        <>
            {
                status &&
                <div className='animate-modal fixed mt-0 inset-0 z-50
                    ...
                    <div className='min-h-screen text-center mx-7'>
                        ...
                        rounded-2xl shadow-2xl shadow-slate-900/50`}>
                            ...
                            <div className="flex space-x-6 px-8 pt-7 pb-6">
                                ...
                                <div className="flex-1">
                                    <div className="text-slate-300 text-2xl font-light tracking-wide">
                                        <span className='font-bold text-indigo-300 mr-3'>{header.title}</span>
                                    </div>
                            ...
                            <div className="md:flex md:space-x-6 md:space-y-0 space-y-3 px-8 py-7
                                bg-gradient-to-tr from-slate-700 to-slate-800">
                                {
                                    ...
                                    :
                                    <div
                                        className='transition rounded-lg cursor-not-allowed text-sm font-light uppercase py-3 px-6
